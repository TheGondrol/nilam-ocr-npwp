...
# deploy_e2e.sh
#
# Build the postprocessor Docker image with e2e tests baked into the
...
# -- Variables ---------------------------------------------------------------
IMAGE_NAME="ms-bribrain-ocr-postprocess"
CONTAINER_NAME="ms-bribrain-ocr-postprocess"
...
echo "  Health    : http://localhost:8090/health/live"
echo ""
