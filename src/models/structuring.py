...
Field NPWP mengikuti sheet "OCR Nilam - Document Type" dan mock ocr-npwp di
nilam-ocr-orchestration: nomor_npwp, nama, nama_badan. Implementasi default
berbasis regex; untuk layout berantakan tambahkan structurer berbasis model
(LLM/layout model) dengan method yang sama.
"""
...
@lru_cache
def get_structurer():
    return build_backend(STRUCTURER_BACKENDS, get_settings().structuring_backend, "structuring")
