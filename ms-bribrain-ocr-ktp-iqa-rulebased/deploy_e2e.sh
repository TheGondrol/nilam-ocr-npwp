...
# deploy_e2e.sh
#
# Build the IQA rule-based Docker image with e2e tests baked into the
...
# -- Variables ---------------------------------------------------------------
IMAGE_NAME="ms-bribrain-ocr-quality"
CONTAINER_NAME="ms-bribrain-ocr-quality"
PORT_MAPPING="8070:8070"
ENV_FILE=".env"
BUILD_ONLY=false
...
echo "  Docs      : http://localhost:8070/docs"
echo "  Health    : http://localhost:8070/health/live"
echo ""
echo "  Test with : curl http://localhost:8070/health"
