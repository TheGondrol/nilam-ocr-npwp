...
# run_e2e_tests.sh
#
# Starts the IQA rule-based service in the background, waits for it to be
# ready, runs e2e tests against it, then kills the server.
...
echo "=========================================="
echo "  E2E Test Runner - IQA Rule-Based"
echo "=========================================="
...
# ------------------------------------------------------------------
echo "[1/4] Starting IQA rule-based service on ${HOST}:${PORT} ..."
