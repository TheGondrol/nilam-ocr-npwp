#!/bin/bash
# Nexus build & push script (Bash) for ms-bribrain-ocr-ktp-tamper-classifier.
...
#
# Examples:
#   ./nexus_build.sh                # -> ocr-ktp/dev/ms-bribrain-ocr-ktp-tamper-classifier:latest
#   ./nexus_build.sh stg v1.2.0     # -> ocr-ktp/stg/ms-bribrain-ocr-ktp-tamper-classifier:v1.2.0
