...
class TestParseVersion:
    ...
    def test_standard_version(self):
        ...
        assert _parse_version("model_v1.2.pth") == (1, 2)
...
class TestDownloadModelGcs:
    ...
    def test_skips_existing_model(self, mock_path_cls, mock_get_client):
        """Test download is skipped when model already exists locally."""
        from src.services.gcs_service import download_model_gcs
        ...
        mock_blob = MagicMock()
        mock_blob.name = "models/tamper_model_v1.0.pth"
    ...
    def test_downloads_latest_version(self, mock_path_cls, mock_get_client):
        ...
        blob_v1 = MagicMock()
        blob_v1.name = "models/tamper_model_v1.0.pth"
        blob_v2 = MagicMock()
        blob_v2.name = "models/tamper_model_v2.0.pth"
