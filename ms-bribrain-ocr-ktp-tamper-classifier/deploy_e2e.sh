...
# deploy_e2e.sh
#
# Build the tamper classifier Docker image with e2e tests baked into the
...
# -- Variables ---------------------------------------------------------------
IMAGE_NAME="ms-bribrain-ocr-tamper"
CONTAINER_NAME="ms-bribrain-ocr-tamper"
...
echo "  Health    : http://localhost:8050/health/live"
echo ""
echo "  Test with : curl http://localhost:8050/health"
