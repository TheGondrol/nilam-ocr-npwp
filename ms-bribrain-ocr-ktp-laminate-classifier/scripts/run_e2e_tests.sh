...
# run_e2e_tests.sh
#
# Starts the laminate classifier in the background, waits for it to be ready,
...
echo "=========================================="
echo "  E2E Test Runner - Laminate Classifier"
echo "=========================================="
...
# ------------------------------------------------------------------
echo "[1/4] Starting laminate classifier on ${HOST}:${PORT} ..."
