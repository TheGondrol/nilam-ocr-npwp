...
# deploy_e2e.sh
#
# Build the laminate classifier Docker image with e2e tests baked into the
...
# -- Variables ---------------------------------------------------------------
IMAGE_NAME="lamination-detection-api"
CONTAINER_NAME="lamination-api"
PORT_MAPPING="8020:8020"
ENV_FILE=".env"
BUILD_ONLY=false
...
echo "  Health    : http://localhost:8020/health/live"
echo ""
echo "  Test with : curl http://localhost:8020/health"
