...
# run_e2e_tests.sh
#
# Starts the graycopy classifier in the background, waits for it to be ready,
...
echo "=========================================="
echo "  E2E Test Runner - Graycopy Classifier"
echo "=========================================="

# ------------------------------------------------------------------
# 1. Start the service in the background
# ------------------------------------------------------------------
echo "[1/4] Starting graycopy classifier on ${HOST}:${PORT} ..."
...
# ------------------------------------------------------------------
echo "[2/4] Waiting for liveness at ${HEALTH_URL} (up to ${MAX_WAIT}s) ..."
