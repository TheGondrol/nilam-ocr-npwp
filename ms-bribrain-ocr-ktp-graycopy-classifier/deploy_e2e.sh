...
# deploy_e2e.sh
#
# Build the graycopy classifier Docker image with e2e tests baked into the
...
# ── Variables ──────────────────────────────────────────────────────────────
IMAGE_NAME="ms-bribrain-ocr-graycopy"
CONTAINER_NAME="ms-bribrain-ocr-graycopy"
...
echo "  Docs      : http://localhost:8040/docs"
echo "  Health    : http://localhost:8040/health/live"
echo ""
