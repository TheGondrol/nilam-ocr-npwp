...
# deploy_e2e.sh
#
# Build the recapture classifier Docker image with e2e tests baked into the
...
# -- Variables ---------------------------------------------------------------
IMAGE_NAME="recapture-detection-api"
CONTAINER_NAME="recapture-api"
...
echo "  Health    : http://localhost:8030/health/live"
echo ""
