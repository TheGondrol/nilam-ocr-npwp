...
class ElasticApmConfig:
    ...
    enabled: bool = False
    server_url: str = ""
    service_name: str = "ocr-ktp-recapture-classifier"
    environment: str = "dev"
...
class Config:
    ...
    def max_image_size_mb(self) -> int:
        """Get maximum allowed image upload size in MB"""
    ...
    def elastic_apm(self) -> ElasticApmConfig:
        ...
        return ElasticApmConfig(
            ...
            service_name=data.get('service_name') or 'ocr-ktp-recapture-classifier',
