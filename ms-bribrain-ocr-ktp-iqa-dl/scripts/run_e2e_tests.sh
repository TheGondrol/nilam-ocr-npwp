...
# run_e2e_tests.sh
#
# Starts the IQA DL classifier in the background, waits for it to be ready,
...
echo "=========================================="
echo "  E2E Test Runner - IQA DL Classifier"
echo "=========================================="
...
# ------------------------------------------------------------------
echo "[1/4] Starting IQA DL classifier on ${HOST}:${PORT} ..."
