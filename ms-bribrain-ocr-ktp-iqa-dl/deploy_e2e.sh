...
# deploy_e2e.sh
#
# Build the IQA deep-learning Docker image with e2e tests baked into the
...
# -- Variables ---------------------------------------------------------------
IMAGE_NAME="ms-bribrain-ocr-ktp-iqa"
CONTAINER_NAME="ocr-ktp-iqa"
PORT_MAPPING="8100:8100"
ENV_FILE=".env"
BUILD_ONLY=false
...
echo "  Health    : http://localhost:8100/health/live"
echo ""
