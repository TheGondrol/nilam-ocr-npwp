#!/bin/bash
# Nexus deploy script (Bash) for ms-bribrain-ocr-ktp-iqa-dl.
...
#
# Examples:
#   ./nexus_deploy.sh                # pulls ocr-ktp/dev/ms-bribrain-ocr-ktp-iqa-dl:latest
#   ./nexus_deploy.sh stg v1.2.0     # pulls ocr-ktp/stg/ms-bribrain-ocr-ktp-iqa-dl:v1.2.0
...
SERVICE_NAME="${SERVICE_NAME:-ms-bribrain-ocr-ktp-iqa-dl}"

CONTAINER_NAME="${CONTAINER_NAME:-ms-bribrain-ocr-ktp-iqa-dl}"
PORT_MAPPING="${PORT_MAPPING:-8100:8100}"
...
echo "Container $CONTAINER_NAME is running on http://localhost:8100"
echo "API Docs: http://localhost:8100/docs"
echo ""
echo "Test with: curl http://localhost:8100${HEALTH_PATH}"
