#!/bin/bash
# Nexus deploy script (Bash) for ms-bribrain-ocr-ktp-orchestrator.
...
#
# Examples:
#   ./nexus_deploy.sh                # pulls ocr-ktp/dev/ms-bribrain-ocr-ktp-orchestrator:latest
#   ./nexus_deploy.sh stg v1.2.0     # pulls ocr-ktp/stg/ms-bribrain-ocr-ktp-orchestrator:v1.2.0
...
SERVICE_NAME="${SERVICE_NAME:-ms-bribrain-ocr-ktp-orchestrator}"

CONTAINER_NAME="${CONTAINER_NAME:-ms-bribrain-ocr-ktp-orchestrator}"
PORT_MAPPING="${PORT_MAPPING:-8000:8000}"
...
echo "Container $CONTAINER_NAME is running on http://localhost:8000"
echo "API Docs: http://localhost:8000/docs"
echo ""
echo "Test with: curl http://localhost:8000${HEALTH_PATH}"
