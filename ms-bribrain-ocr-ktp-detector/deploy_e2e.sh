...
# deploy_e2e.sh
#
# Build the detector Docker image with e2e tests baked into the
...
# -- Variables ---------------------------------------------------------------
IMAGE_NAME="ms-bribrain-ocr-detection"
CONTAINER_NAME="ms-bribrain-ocr-detection"
PORT_MAPPING="8060:8060"
ENV_FILE=".env"
BUILD_ONLY=false
...
echo "  Health    : http://localhost:8060/health/live"
echo ""
echo "  Test with : curl http://localhost:8060/health"
