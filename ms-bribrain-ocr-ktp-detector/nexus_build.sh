#!/bin/bash
# Nexus build & push script (Bash) for ms-bribrain-ocr-ktp-detector.
...
#
# Examples:
#   ./nexus_build.sh                # -> ocr-ktp/dev/ms-bribrain-ocr-ktp-detector:latest
#   ./nexus_build.sh stg v1.2.0     # -> ocr-ktp/stg/ms-bribrain-ocr-ktp-detector:v1.2.0
